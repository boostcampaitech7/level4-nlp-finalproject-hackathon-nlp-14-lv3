        ...
        for excel_file in os.listdir(company_path):
            if excel_file.endswith(".xlsx"):
                ...
                for idx, row in df.iterrows():
                    ...
                    clean_embedding_vector = None
                    if embedding_text and isinstance(embedding_text, str):
                        embedding_vector = embedding_model.get_embedding(embedding_text)
                        cleaned_text = clean_korean_text(clean_text(embedding_text))
                        clean_embedding_vector = embedding_model.get_embedding(cleaned_text)
                    ...
                    embedding_insert = {
                        ...
                        "clean_text_embedding_vector": clean_embedding_vector,
                    }
